...
def myNetwork():
    ...
    net.addLink(s27, h14)
    net.addLink(s28, h15)
    s14s29 = {'delay':'7','loss':4}
    net.addLink(s14, s29, cls=TCLink , **s14s29)
    s15s30 = {'delay':'2','loss':3}
    net.addLink(s15, s30, cls=TCLink , **s15s30)
    net.addLink(s30, s29)
    s14s30 = {'delay':'2','loss':4}
    net.addLink(s14, s30, cls=TCLink , **s14s30)
    s29s15 = {'delay':'1','loss':2}
    net.addLink(s29, s15, cls=TCLink , **s29s15)
    s29s16 = {'delay':'2','loss':3}
    net.addLink(s29, s16, cls=TCLink , **s29s16)
    s31s17 = {'delay':'1','loss':5}
    net.addLink(s31, s17, cls=TCLink , **s31s17)
    s17s29 = {'delay':'4','loss':5}
    net.addLink(s17, s29, cls=TCLink , **s17s29)
    s16s31 = {'delay':'5','loss':6}
    net.addLink(s16, s31, cls=TCLink , **s16s31)
    s29s31 = {'delay':'5','loss':6}
    net.addLink(s29, s31, cls=TCLink , **s29s31)
    s31s32 = {'delay':'6','loss':8}
    net.addLink(s31, s32, cls=TCLink , **s31s32)
    net.addLink(s32, s34)
    s31s33 = {'delay':'4','loss':3}
    net.addLink(s31, s33, cls=TCLink , **s31s33)
    s32s33 = {'delay':'4','loss':3}
    net.addLink(s32, s33, cls=TCLink , **s32s33)
    s31s34 = {'delay':'4','loss':6}
    net.addLink(s31, s34, cls=TCLink , **s31s34)
    s29s33 = {'delay':'6','loss':7}
    net.addLink(s29, s33, cls=TCLink , **s29s33)
    s34s35 = {'delay':'4','loss':2}
    net.addLink(s34, s35, cls=TCLink , **s34s35)
    s35s37 = {'delay':'3','loss':3}
    net.addLink(s35, s37, cls=TCLink , **s35s37)
    s35s36 = {'delay':'5','loss':2}
    net.addLink(s35, s36, cls=TCLink , **s35s36)
    s35s38 = {'delay':'5','loss':4}
    net.addLink(s35, s38, cls=TCLink , **s35s38)
    s38s36 = {'delay':'6','loss':3}
    net.addLink(s38, s36, cls=TCLink , **s38s36)
    s37s36 = {'delay':'5','loss':7}
    net.addLink(s37, s36, cls=TCLink , **s37s36)
    net.addLink(s34, s38)
    s35s33 = {'delay':'3','loss':3}
    net.addLink(s35, s33, cls=TCLink , **s35s33)
    s30s31 = {'delay':'3','loss':5}
    net.addLink(s30, s31, cls=TCLink , **s30s31)
    net.addLink(s60, h28)
    net.addLink(s60, h29)
    net.addLink(s59, h26)
    net.addLink(s59, h27)
    ...
    net.addLink(s42, s45)
    net.addLink(s45, s60)
    s32s47 = {'delay':'6','loss':3}
    net.addLink(s32, s47, cls=TCLink , **s32s47)
    net.addLink(s33, s24)
    s32s24 = {'delay':'2','loss':2}
    net.addLink(s32, s24, cls=TCLink , **s32s24)
    net.addLink(s33, s47)
    net.addLink(s47, s48)
    net.addLink(s47, s24)
    net.addLink(s24, s23)
